...
try:
#     # caffe_root = '/home/amax/caffe_ssd/caffe/'
#     caffe_root = '/opt/movidius/caffe/'
#     # caffe_root = '/workspace/lurs/work/prj/gesture-recognition/caffe/'
...
def make_parser():
    ...
    parser.add_argument('--model', type=str, help='.prototxt file for inference')
    parser.add_argument('--weights', type=str, help='.caffemodel file for inference')
    return parser
...
if __name__ == '__main__':
    ...
    args.model='/home/amax/workspace/pytorch_caffe/mobilenet_iter_73000.caffemodel'
    # pre_process(args.model, "/home/amax/workspace/pytorch_caffe/deploy.prototxt")

    net = caffe.Net(args.model, "/home/amax/workspace/pytorch_caffe/deploy.prototxt", caffe.TEST)
    net2 = caffe.Net("./converted_model/MobileNetSSD_no_bn.prototxt", caffe.TEST)

    load_weights(net, net2)
    net2.save("./converted_model/MobileNetSSD_no_bn.caffemodel")
